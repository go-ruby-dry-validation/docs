...
`go-ruby-dry-validation/dry-validation` reimplements Ruby's `dry-validation` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-dry-validation/dry-validation` directly, with no Ruby runtime;
