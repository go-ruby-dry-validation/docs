...
The public API lives at the module root (`github.com/go-ruby-dry-validation/dry-validation`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `dry-validation`, while the surface follows
...
```go
import "github.com/go-ruby-dry-validation/dry-validation"
```
...
- **[pkg.go.dev/github.com/go-ruby-dry-validation/dry-validation](https://pkg.go.dev/github.com/go-ruby-dry-validation/dry-validation)**

The module's [README](https://github.com/go-ruby-dry-validation/dry-validation#readme) carries worked
